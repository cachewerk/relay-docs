...
class Relay {
    ...
    /**
     * Get the number of bytes sent and received over the network during the Relay object's
     ...
     */
    #[\Relay\Attributes\RedisCommand]
    public function eval_ro(mixed $script, array $args = [], int $num_keys = 0): \Relay\Relay|mixed|false;
     ...
     */
    #[\Relay\Attributes\RedisCommand]
    public function evalsha_ro(string $sha, array $args = [], int $num_keys = 0): \Relay\Relay|mixed|false;
    ...
    /**
     * Clear the accumulated sent and received bytes.  This can be useful to trace the number of
     * bytes for a specific command or sequence of commands.
     *
     * @return void
     */
    #[\Relay\Attributes\Local]
    ...
    // public function put_host(string $host): array;
